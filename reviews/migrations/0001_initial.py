    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recomendation', models.CharField(choices=[('Must Watch', 'Must Watch'), ('Should Watch', 'Shold Watch'), ('Avoid Watch', 'Avoid Watch'), ('No Opinion', 'Default')], default='No Opinion', max_length=50)),
